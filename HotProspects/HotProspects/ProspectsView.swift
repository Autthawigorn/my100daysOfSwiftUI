...
struct ProspectsView: View {
    ...
    var body: some View {
            ...
            .sheet(isPresented: $isShowingScanner) {
                CodeScannerView(codeTypes: [.qr, .catBody], simulatedData: "Paul Hudson\npaul@hackingwithswift.com", completion: handleScan)
            }
            .onAppear {
                selectedProspects = []
            }
    ...
    func delete() {
        for prospee in selectedProspects {
            modelContext.delete(prospee)
        }
    }
...
#Preview {
    ProspectsView(filter: .contacted, sort: SortDescriptor(\Prospect.name))
